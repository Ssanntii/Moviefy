    ...
    const getDetail = async () => {
      try {
        ...
        if (response) {
          ...
          console.error('Detail response is invalid:', response);
          setError(true);
        }
      } catch (error) {
    ...
    <>
      ...
      <div className="flex items-start justify-start max-w-7xl mx-auto -mt-[200px] relative px-8 mb-12">
        ...
        <div className="flex-1 md:hidden">
          <div
            className="bg-center bg-cover bg-no-repeat rounded-lg pt-[165%] shadow-lg"
            style={{
              backgroundImage: `url(${apiConfig.originalImage(
      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-8">Similar {category === 'movie' ? 'Movies' : 'TV Shows'}</h2>
